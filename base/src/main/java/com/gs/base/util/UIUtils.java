...
import static com.gs.base.util.ScreenUtils.getStatusBarHeight;
...
public class UIUtils {
    ...
    public static void showToast(int msgId) {
        showToast(BaseApp.getContext().getString(msgId));
    }
    ...
    public static void GetInfo(Context context) {
        ...
        Log.d("GetInfo", "screenWidth=" + screenWidth + " screenHeight=" + screenHeight + " density=" + density);
    }
