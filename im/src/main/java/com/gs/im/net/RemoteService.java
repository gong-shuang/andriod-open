package com.gs.im.net;

import com.gs.im.model.api.RspModel;
import com.gs.im.model.api.account.AccountRspModel;
...
import com.gs.im.model.api.user.UserUpdateModel;
...
public interface RemoteService {
    ...
    // 获取关注我的人的列表
    @GET("user/follow")
    Call<RspModel<List<UserCard>>> userFollowers();
