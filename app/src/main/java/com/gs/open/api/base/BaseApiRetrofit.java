package com.gs.open.api.base;

import android.content.Context;
import android.content.SharedPreferences;

import com.gs.open.api.base.persistentcookiejar.ClearableCookieJar;
import com.gs.open.api.base.persistentcookiejar.PersistentCookieJar;
...
//                .addInterceptor(REWRITE_CACHE_CONTROL_INTERCEPTOR)
                .addInterceptor(new AddHeaderInterceptor(MyApp.getContext()))
                .addInterceptor(new ReceivedCookiesInterceptor(MyApp.getContext()))
...
//                .addHeader("Cookie", "add cookies here")
    ...
    public class ReceivedCookiesInterceptor implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (!originalResponse.headers("Set-Cookie").isEmpty()) {
                ...
                SharedPreferences.Editor config = mContext.getSharedPreferences(API_SP_NAME_NET, MODE_PRIVATE)
                        .edit();
                config.putStringSet(API_SP_KEY_NET_COOKIE_SET, cookiesSet);
                config.apply();
            }
    ...
    public class AddHeaderInterceptor implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            SharedPreferences preferences = mContext.getSharedPreferences(API_SP_NAME_NET,
                    Context.MODE_PRIVATE);

            //添加cookie
            HashSet<String> cookieSet = (HashSet<String>) preferences.getStringSet(API_SP_KEY_NET_COOKIE_SET, null);
            if (cookieSet != null) {
            ...
            //添加用户登录认证
            String auth = preferences.getString(API_SP_KEY_NET_HEADER_AUTH, null);
            if(auth != null) {
