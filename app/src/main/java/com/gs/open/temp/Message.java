...
//    private ReadReceiptInfo readReceiptInfo;
    ...
    public Message(Message msg) {
        this.conversationType = msg.getConversationType();
        this.targetId = msg.getTargetId();
        this.messageId = msg.getMessageId();
        this.messageDirection = msg.getMessageDirection() ;
        this.senderUserId = msg.getSenderUserId();
        this.receivedStatus = msg.receivedStatus;
        this.sentStatus = msg.getSentStatus();
