...
//import com.gs.open.model.message.RedPacketMessage;
...
import com.gs.open.util.VideoThumbLoader;
...
public class SessionAdapter extends LQRAdapterForRecyclerView<Message> {
 ...
 //       if (!(item.getContent() instanceof GroupNotificationMessage) &&
        //       !(item.getContent() instanceof RecallNotificationMessage) &&
        //       (getItemViewType(position) != UNDEFINE_MSG)) {
 ...
 //       }
    ...
    private void setView(LQRViewHolderForRecyclerView helper, Message item, int position) {
        ...
        LogUtils.e("msgContent : " + msgContent);
