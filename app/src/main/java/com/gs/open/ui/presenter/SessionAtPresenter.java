...
//                //每次只有一个数据
//                Message messageUI = toMessageUI(message);
//                if(!(messageUI != null && messageUI.getTargetId().equals(mSessionId)))
//                    return;
//                int index=-1;
//                for(int i=0; i < mData.size(); i++){
//                    if(mData.get(i).getMessageId().equals(messageUI.getMessageId())){
//                        index = i;
//                    }
//                }
//                if(index == -1){
//                    //新增
//                    mData.add(mData.size() - 1,messageUI);
//                    getView().getRvMsg().moveToPosition(mData.size() - 1);
//                }else{
//                    //更新
//                    mData.remove(index);
//                    mData.add(index, messageUI);
